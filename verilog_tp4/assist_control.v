...
// Freio: atencao/critico no centro. Seta: livre, depois atencao.
// saida_segura so veta se o obstaculo aproximar >= 10 cm (caso extremo).

module assist_control #(
    parameter REDUC_ATENCAO = 8'd20,
    parameter REDUC_CRITICO = 8'd40,
    parameter signed [7:0] LIMIAR_SAIDA = -8'sd10
) (
    ...
    wire saida_segura_e = (vel_e > LIMIAR_SAIDA);
    wire saida_segura_c = (vel_c > LIMIAR_SAIDA);
    wire saida_segura_d = (vel_d > LIMIAR_SAIDA);
    ...
    always @(*) begin
        ...
        // Normal: cfg (livre > atencao). saida_segura so barra aproximacao extrema.
